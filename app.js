...
function exportTickets(){
  downloadCSV('sarab-ticketing-requests.csv', [
    ['Ticket ID','Date','Status','Priority','Escalated','Client','Plate','Vehicle','Category','Location','Requested By','Assigned To','Provider','SLA Days','Days Open','Description','Action / Notes'],
    ...state.tickets.map(t=>[t.ticketNo,t.date,t.status,t.priority,t.escalated ? 'Yes' : 'No',t.client,t.plate,t.vehicle,t.category,t.location,t.requestedBy,t.assignedTo,t.provider,t.slaDays,ticketDaysOpen(t),t.description,t.action])
  ]);
}
